        ...
        fun bind(weather: WeatherResource) {
            with(binding) {
                ...
                weatherFeelsLike.text =
                    root.context.getString(R.string.weather_feels_like, weather.main.feelsLike.formatToShow())
                weatherHumidity.text =
                    root.context.getString(R.string.weather_humidity, weather.main.humidity.formatToShow())
